...
class SqrtTransform extends RecursiveAction {
    ...
    // This is hte method in which parallel computation will occur.
    protected void compute() {
        // If number of elements s below the sequential threshold,
...
public class ForkJoinDemo {
    public static void main(String[] args) {
        ...
        System.out.println("A portion of the transformed sequence (to four decimal placers:");
